...
public class CustRegisterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cust_activity_register);
        ...
        if (session.isLoggedIn()) {
            Intent intent = new Intent(CustRegisterActivity.this, CustHome.class);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), CustLoginActivity.class);
                startActivity(i);
                finish();
            }
        });
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        //laundh login act
                        Intent intent = new Intent(CustRegisterActivity.this, CustLoginActivity.class);
                        startActivity(intent);
                        finish();
                    } else {
